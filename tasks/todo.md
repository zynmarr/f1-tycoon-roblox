# Task Checklist: F1-Tycoon Roadmap

## Phase 1: Shared Track (Feature 2) - [COMPLETED]
- [x] **Task 1**: Update vehicle driving physics & speed scaling based on Rarity/Variant.
- [x] **Task 2**: Implement track zone boundary validation in `RaceManager.luau`.
- [x] **Task 3**: Build `TrackHUD.luau` for real-time speed & lap timing.

## Phase 2: Team Manager & Automated Race (Feature 3) - [COMPLETED]
- [x] **Task 4**: Add `TeamManager` data schema to `DataManager.luau`.
- [x] **Task 5**: Build `TeamManagerModal.luau` UI for driver lineup selection.
